import { FaBuilding, FaCartPlus, FaChalkboardTeacher, FaCode, FaDesktop, FaGraduationCap, FaRegListAlt } from "react-icons/fa";
import ProfessionalCard from "../ProfessionalCard";

const ProfessionalCarreer = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p>
        ...
        Today, more than 10 years later, I&apos;m a <b>professional back-end software engineer</b>.
